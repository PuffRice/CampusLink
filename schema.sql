...
CREATE TABLE public.ta_assignments (
  ...
  CONSTRAINT ta_assignments_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.users(id),
  CONSTRAINT ta_assignments_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.users(id),
  CONSTRAINT ta_assignments_assigned_by_fkey FOREIGN KEY (assigned_by) REFERENCES public.users(id),
...
CREATE TABLE public.ta_office_hours (
  ...
  location text,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT ta_office_hours_pkey PRIMARY KEY (id),
  CONSTRAINT ta_office_hours_assignment_fkey FOREIGN KEY (ta_assignment_id) REFERENCES public.ta_assignments(id),
  CONSTRAINT ta_office_hours_valid_range CHECK (end_time > start_time),
  CONSTRAINT ta_office_hours_unique_slot UNIQUE (ta_assignment_id, day, start_time, end_time)
);
